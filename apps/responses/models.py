...
class Response(models.Model):
    ...
    survey = models.ForeignKey('surveys.Survey', on_delete=models.PROTECT, related_name='responses', verbose_name='pesquisa')
...
class RegionalResponse(Response):
    ...
    city = models.ForeignKey(City, verbose_name='cidade', related_name='responses', on_delete=models.PROTECT)
    sector = models.ForeignKey(Sector, verbose_name='setor', related_name='responses', on_delete=models.PROTECT)
    neighborhood = models.ForeignKey(Neighborhood, verbose_name='bairro', related_name='responses', on_delete=models.SET_NULL, null=True, blank=True)
...
class Answer(models.Model):
    response = models.ForeignKey(Response, verbose_name='entrevista', related_name='answers', on_delete=models.CASCADE)
    question = models.ForeignKey('surveys.Question', verbose_name='pergunta', related_name='answers', on_delete=models.PROTECT)
    creation_date = models.DateTimeField('data de criação', auto_now_add=True)
    modification_date = models.DateTimeField('data de modificação', auto_now=True)
